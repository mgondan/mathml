...
`mathml` contains several basic elements used in everyday mathematical expressions. For example it is possible to print the function for the linear regression as:
...
Then, we may want underline the incorrect term and provide the correct solution.

```{r, results="asis"}
# It underlines what has been incorrect
...
Finally, we can simply provide the correct solution to the problem with the flag `ignore`. 
