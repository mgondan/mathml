...
=======
>>>>>>> d6b1bec3b266394c48c81c3efcddad814ae9d071
...
```{r add, echo=FALSE}
op <- list(left=quote(add_left(a + b)), right=quote(add_right(a + b)), list=quote(add(c)))
m <- lapply(op, FUN=mathjax, flags=list(cat=FALSE))
...
=======
Alternatively, we can put the correct solution in a box to let the student focus  on the correction.
>>>>>>> d6b1bec3b266394c48c81c3efcddad814ae9d071
