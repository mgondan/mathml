...
signs. Moreover, in addition to graphical rendering, the same R expression provides its calculation or evaluation. This feature of the package saves the user's time and allows faster detection of errors.
