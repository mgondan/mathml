...
the main features of the \pkg{mathml} package, potential issues and their
...
R\ package \pkg{rolog} [@rolog]. Prolog is a classical logic programming
...
namespace [manually defined, or from R package \pkg{pracma}, @pracma], so that
