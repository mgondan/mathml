...
abstract: >
  ...
  The use of the package is displayed throughout the paper by examples and its
  application is illustrated as a case study in a scientific report.
...
knitr::kable(t, caption="Observed RT Means and SDs of [@miller]'s study in 
             [@schwarz1994, p. 513]", row.names=FALSE, escape=FALSE)
```
