...
Prolog interpreter from R\ package \pkg{rolog} [@rolog]. Prolog is a classical logic
...
To avoid name clashes with package \pkg{stats}, `roof()` is used to put a hat
...
For example, in its current stage, the LaTeX package \pkg{breqn} [@breqn] is mostly
a proof of concept.
...
Supported by the Erasmus+ programme of the European
