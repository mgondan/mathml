...
# todo: https://getdoc.wiki/Mathml-set
# todo: complex numbers, Re, Im
# todo: package stats (e.g., integrate)
# todo: sum for k \in calligraphic(K), P(K = k) * pi_K
# todo: hook for custom functions and macros
