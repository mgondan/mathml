...
# x %up% y: NOT WORKING
# catmath(symbol(x %up% y))
# catmathjax(symbol(x %up% y))

# x %down% y: NOT WORKING
# catmath(symbol(x %down% y))
# catmathjax(symbol(x %down% y))
...
# x %dblup% y: NOT WORKING
# catmath(symbol(x %dblup% y))
# catmathjax(symbol(x %dblup% y))

# x %dbldown% y: NOT WORKING
# catmath(symbol(x %dbldown% y))
# catmathjax(symbol(x %dbldown% y))
...
# It works, but it is NOT correct
catmath(32*degree)
catmathjax(32*degree)

# It works, but it is NOT correct
catmath(60*minute)
catmathjax(60*minute)

# It works, but it is NOT correct
catmath(30*second)
catmathjax(30*second)
...
catmath(f <- function(x) sin(x))
catmathjax(f <- function(x) sin(x))
