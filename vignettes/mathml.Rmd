...
The R\ package `mathml` defines a set of rules for the automatic translation of
...
To avoid name clashes with package _stats_, `roof()` is used to put a hat
...
one of the main sources of mistakes. For illustration, we consider a complicated
equation [e.g., @schwarz1994].
...
line breaks. This is mostly due to lacking support by MathML and LaTeX renderers.
