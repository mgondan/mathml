...
Another, not-yet-mentioned use of \pkg{mathml} can be found in presentations  made using R Markdown. By adopting \pkg{mathml} researchers or teachers can use a single interface to conduct analysis and show results, without having to move parts of code or figures from one file to another. This contributes in making the process smoother and the graphical output more coherent.   
