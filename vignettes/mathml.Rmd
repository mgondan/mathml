...
Unclear why we need to point at .GlobalEnv. Without, there is an error message
stating that gg is not found in r_eval.

```{r, results='asis'}
.GlobalEnv$g <- function(x, u)
  sin(x)

term <- quote(integrate(lower=0L, upper=2L*pi, g))
mathout(canonical(term))
```
