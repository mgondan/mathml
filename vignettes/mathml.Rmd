...
xfun_html_escape <- function (x, attr=FALSE) 
{
    x = gsub("&", "&amp;", x, fixed=TRUE)
    x = gsub("<", "&lt;", x, fixed=TRUE)
    x = gsub(">", "&gt;", x, fixed=TRUE)
...
if(knitr::is_html_output())
  op1 <- sapply(op1, FUN=xfun_html_escape, attr=TRUE)
...
if(knitr::is_html_output())
  op2 <- sapply(op2, FUN=xfun_html_escape, attr=TRUE)
...
if(knitr::is_html_output())
  op3 <- sapply(op3, FUN=xfun_html_escape, attr=TRUE)
